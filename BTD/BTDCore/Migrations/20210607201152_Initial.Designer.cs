...
namespace BTDCore.Migrations
{
    ...
    [Migration("20210607201152_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTDCore.Models.EventLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BTDCore.Models.Notice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BTDCore.Models.SystemEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BTDCore.Models.Table", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BTDCore.ViewModels.ViewEventLog", b =>
                {
                    b.Property<DateTime>("DateOfEvent")
                        .HasColumnType("datetime2");
                    ...
                    b.ToView("View_EventLog");
                });

            modelBuilder.Entity("BTDCore.ViewModels.ViewNotice", b =>
                {
                    b.Property<string>("Designation")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BTDCore.Models.EventLog", b =>
                {
                    b.HasOne("BTDCore.Models.SystemEvent", "Event")
                        .WithMany("EventsLog")
                        .HasForeignKey("SystemEventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTDCore.Models.Table", "NameCard")
                        .WithMany()
